...
testthat::test_that("Check the BT_Perf function - Validation only",{
  ...
  plot(seq_len(BT_algo$BTParams$n.iter), BT_algo$BTErrors$training.error, type = 'l')
  lines(seq_len(BT_algo$BTParams$n.iter), BT_algo$BTErrors$validation.error, col = 'red')
...
testthat::test_that("Check the BT_Perf function - CV only",{
  ...
  # Visual checks on the produce plot.
  plot(seq_len(BT_algo$BTParams$n.iter), BT_algo$BTErrors$training.error, type = 'l')
  lines(seq_len(BT_algo$BTParams$n.iter), BT_algo$BTErrors$cv.error, col = 'red')
