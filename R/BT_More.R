...
BT_more <- function(BTFit_object, new.n.iter=100, is.verbose=FALSE, seed = NULL){
  ...
  # Call BT package
  BT_more_fit <- BT_callBoosting(BTFit_object$BTData$training.set,
  ...
  BT_more_fit$BTErrors <- structure(list(training.error = c(BTFit_object$BTErrors$training.error, BT_more_fit$BTErrors$training.error),
                                         validation.error=c(BTFit_object$BTErrors$validation.error, BT_more_fit$BTErrors$validation.error),
                                         oob.improvement=c(BTFit_object$BTErrors$oob.improvement, BT_more_fit$BTErrors$oob.improvement)), class="BTErrors")
